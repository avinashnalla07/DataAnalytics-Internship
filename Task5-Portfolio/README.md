...
- [Task 1 — Data Wrangling](../Task1-Data-Wrangling/)
- [Task 2 — EDA & Business Intelligence](../Task2-EDA/)
- [Task 3 — Deep-Dive Analysis](../Task3-Dashboard/)
- [Task 4 — Statistical Validation](../Task4-Storytelling/)
- [Task 5 — Portfolio](../Task5-Portfolio/)
...
*Built during the Data Analytics Internship at ApexPlanet Software Pvt. Ltd.*
